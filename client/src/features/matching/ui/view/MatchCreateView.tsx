...
import { Platform, Modal, ScrollView, View, TouchableOpacity, StyleSheet } from 'react-native';
...
function DateInputField({
  ...
  return (
    <View>
      ...
      <Spacing size={1} />
      <TouchableOpacity
        style={[pickerStyles.field, error ? pickerStyles.fieldError : null]}
        onPress={handlePress}
        activeOpacity={0.7}
      >
      ...
      {error ? (
        <TextBox variant="caption" color={colors.error} style={pickerStyles.errorText}>
          {error}
        </TextBox>
      ) : null}
